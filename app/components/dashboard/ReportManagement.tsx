...
const reportFrequencyData: Record<string, { count: number; status: "high" | "mild" | "low" }> = {
  ...
  "coach_suspicious": { count: 4, status: "mild" },
...
const initialReports = [
  ...
  },
  {
    ...
    accused: "coach_suspicious",
    accusedVerification: "verified" as const,
    category: "User Misconduct",
    status: "Resolved",
    date: "2025-10-04 16:20",
    description: "Coach inappropriately messaging players.",
...
export function ReportManagement() {
  ...
  const handleBanUser = () => {
    ...
    toast.success(
      `User ${selectedReport.accused} has been ${banTypeText} for ${banDuration} hours`
    );
